...
void main() {
  ...
  testWidgets('Focus loss clears physical keyboard pressed keys', (WidgetTester tester) async {
    await simulateKeyDownEvent(LogicalKeyboardKey.altLeft, platform: 'android');
    expect(HardwareKeyboard.instance.isPhysicalKeyPressed(PhysicalKeyboardKey.altLeft), isTrue);
    expect(RawKeyboard.instance.keysPressed.contains(LogicalKeyboardKey.altLeft), isTrue);

    final unfocusEvent = ui.ViewFocusEvent(
