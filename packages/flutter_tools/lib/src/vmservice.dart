...
/// Exception thrown when connecting to the VM Service protocol fails due to
/// the device being offline or disconnected.
class ServiceProtocolConnectionException implements Exception {
  ServiceProtocolConnectionException(this.message);
