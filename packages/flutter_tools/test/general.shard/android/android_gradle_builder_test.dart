...
''');
    ...
    testUsingContext(
      'throws ToolExit when building APK in release mode if native-debug-symbols.zip is missing',
      () async {
        final builder = AndroidGradleBuilder(
          java: FakeJava(),
          logger: logger,
    ...
    testUsingContext(
      'succeeds when building APK in release mode if native-debug-symbols.zip is present',
      () async {
        final builder = AndroidGradleBuilder(
          java: FakeJava(),
          logger: logger,
          ...
          FakeCommand(
            ...
            onRun: (_) {
              fileSystem
                  ...
                  .childFile('native-debug-symbols.zip')
                  .createSync(recursive: true);
            },
          ),
        );
    ...
    testUsingContext(
      'deletes stale native-debug-symbols.zip before starting Gradle task',
      () async {
        final builder = AndroidGradleBuilder(
          java: FakeJava(),
          logger: logger,
