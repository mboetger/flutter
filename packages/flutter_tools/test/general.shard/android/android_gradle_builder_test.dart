...
''';
      ...
      testUsingContext(
        'does not throw tool exit for missing debug symbols when building release app bundle if androidValidateStrippedDebugSymbols is false',
        () async {
          final builder = AndroidGradleBuilder(
            java: FakeJava(),
            logger: logger,
          ...
          createSharedGradleFiles();
          createAabFile(BuildMode.release);
          ...
          await builder.buildGradleApp(
            ...
            androidBuildInfo: const AndroidBuildInfo(
              BuildInfo(
                ...
                treeShakeIcons: false,
                packageConfigPath: '.dart_tool/package_config.json',
                androidValidateStrippedDebugSymbols: false,
              ),
              targetArchs: <AndroidArch>[
                AndroidArch.arm64_v8a,
                AndroidArch.armeabi_v7a,
