...
void main() {
  group('gradle build', () {
    ...
    testUsingContext('throws ToolExit when gradle task fails with exit code -1', () async {
      final builder = AndroidGradleBuilder(
        java: FakeJava(),
        logger: logger,
        processManager: processManager,
      ...
      await expectLater(
        ...
        throwsToolExit(
          message:
              ...
              'This exit code may indicate that the Gradle daemon was killed or crashed',
        ),
      );
    }, overrides: <Type, Generator>{AndroidStudio: () => FakeAndroidStudio()});
