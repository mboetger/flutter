...
''');
    ...
    testUsingContext(
      'prints warning if minSdkVersion < 28 and taskAffinity is missing',
      () async {
        final builder = AndroidGradleBuilder(
          java: FakeJava(),
          logger: logger,
        ...
        project.android.appManifestFile
          ..createSync(recursive: true)
          ..writeAsStringSync(minimalV2EmbeddingManifest); // Lacks taskAffinity
        ...
        expect(
          logger.statusText,
          contains("Warning: this application's AndroidManifest.xml file leaves it vulnerable"),
        );
      },
      overrides: <Type, Generator>{AndroidStudio: () => FakeAndroidStudio(), Logger: () => logger},
    );

    testUsingContext(
      'does not print warning if minSdkVersion >= 28 and taskAffinity is missing',
      () async {
        final builder = AndroidGradleBuilder(
          java: FakeJava(),
          logger: logger,
    ...
    testUsingContext(
      'does not print warning if taskAffinity is specified',
      () async {
        final builder = AndroidGradleBuilder(
          java: FakeJava(),
          logger: logger,
