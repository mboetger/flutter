    ...
    testWithoutContext('stdout contains release, debug and profile', () async {
      ...
      expect(
        ...
        contains(
          ...
          '  1. Open <host>/settings.gradle (Groovy) or <host>/settings.gradle.kts (Kotlin DSL)\n'
          ...
          '         }\n'
          '\n'
          '  3. Alternatively, for older projects without settings.gradle repository configuration, configure the repositories in <host>/app/build.gradle (Groovy) or <host>/app/build.gradle.kts (Kotlin DSL):\n'
          '\n'
          ...
          '         }\n'
          '\n'
          '  4. Open <host>/app/build.gradle (Groovy) or <host>/app/build.gradle.kts (Kotlin DSL) and add the dependencies:\n'
          '\n'
          '     For build.gradle (Groovy):\n'
          '\n'
          '         dependencies {\n'
