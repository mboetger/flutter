...
TEST(FlutterMainSelectedRenderingAPI, SelectsSkiaOpenGLESWhenImpellerDisabledOnApi29Plus) {
  Settings settings;
  settings.enable_software_rendering = false;
...
TEST(FlutterMainSelectedRenderingAPI, SelectsExplicitImpellerBackendWhenRequested) {
  Settings settings;
  settings.enable_software_rendering = false;
  settings.enable_impeller = true;
...
TEST(FlutterMainSelectedRenderingAPI, SelectsSkiaOpenGLESWhenBackendRequestedWithImpellerDisabled) {
  Settings settings;
  settings.enable_software_rendering = false;
  settings.enable_impeller = false;
...
TEST(FlutterMainSelectedRenderingAPI, SelectsAutoselectWhenUnrecognizedBackendRequested) {
  Settings settings;
  settings.enable_software_rendering = false;
  settings.enable_impeller = true;
