...
TEST(AndroidHardwareBufferTest, FormatAndBytesPerPixel) {
  EXPECT_EQ(AndroidHardwareBufferBytesPerPixel(static_cast<uint32_t>(
                AndroidHardwareBufferFormat::kR8G8B8A8_UNORM)),
            4u);
  EXPECT_EQ(AndroidHardwareBufferBytesPerPixel(static_cast<uint32_t>(
                AndroidHardwareBufferFormat::kR8G8B8X8_UNORM)),
            4u);
  EXPECT_EQ(AndroidHardwareBufferBytesPerPixel(static_cast<uint32_t>(
                AndroidHardwareBufferFormat::kR8G8B8_UNORM)),
            3u);
  EXPECT_EQ(AndroidHardwareBufferBytesPerPixel(static_cast<uint32_t>(
                AndroidHardwareBufferFormat::kR5G6B5_UNORM)),
            2u);
  EXPECT_EQ(AndroidHardwareBufferBytesPerPixel(static_cast<uint32_t>(
                AndroidHardwareBufferFormat::kR16G16B16A16_FLOAT)),
            8u);
  EXPECT_EQ(AndroidHardwareBufferBytesPerPixel(static_cast<uint32_t>(
                AndroidHardwareBufferFormat::kR10G10B10A2_UNORM)),
            4u);
  EXPECT_EQ(AndroidHardwareBufferBytesPerPixel(
                static_cast<uint32_t>(AndroidHardwareBufferFormat::kBlob)),
            1u);
  EXPECT_EQ(AndroidHardwareBufferBytesPerPixel(
                static_cast<uint32_t>(AndroidHardwareBufferFormat::kD16_UNORM)),
            2u);
  EXPECT_EQ(AndroidHardwareBufferBytesPerPixel(
                static_cast<uint32_t>(AndroidHardwareBufferFormat::kR8_UNORM)),
            1u);
  EXPECT_EQ(AndroidHardwareBufferBytesPerPixel(
                static_cast<uint32_t>(AndroidHardwareBufferFormat::kR16_UINT)),
            2u);
  EXPECT_EQ(AndroidHardwareBufferBytesPerPixel(static_cast<uint32_t>(
                AndroidHardwareBufferFormat::kR16G16_UINT)),
            4u);
}
...
TEST(AndroidHardwareBufferTest, DescriptorCreationAndEquality) {
  ...
  EXPECT_EQ(desc1.format, static_cast<uint32_t>(
                              AndroidHardwareBufferFormat::kR8G8B8A8_UNORM));
