...
static void SetViewportMetrics(JNIEnv* env,
                               ...
                               jint physicalWidth,
                               jint physicalHeight,
                               jint physicalWidthMin,
                               jint physicalWidthMax,
                               jint physicalHeightMin,
                               jint physicalHeightMax,
  ...
  const flutter::ViewportMetrics metrics{
      ...
      static_cast<double>(physicalWidthMin),
      static_cast<double>(physicalWidthMax),
      static_cast<double>(physicalHeightMin),
      static_cast<double>(physicalHeightMax),
...
bool RegisterApi(JNIEnv* env) {
  static const JNINativeMethod flutter_jni_methods[] = {
      ...
      },
      {
          ...
          .signature = "(JFIIIIIIIIIIIIIIIII[I[I[I)V",
