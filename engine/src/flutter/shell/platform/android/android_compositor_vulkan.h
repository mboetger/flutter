...
#ifndef FLUTTER_SHELL_PLATFORM_ANDROID_ANDROID_COMPOSITOR_VULKAN_H_
#define FLUTTER_SHELL_PLATFORM_ANDROID_ANDROID_COMPOSITOR_VULKAN_H_
...
class AndroidCompositorVulkan {
 public:
  explicit AndroidCompositorVulkan(
      std::shared_ptr<impeller::ContextVK> context);
  ~AndroidCompositorVulkan();

  void SetNativeWindow(ANativeWindow* window);

  std::unique_ptr<EmbedderRenderTarget> CreateRenderTarget(
...
#endif  // FLUTTER_SHELL_PLATFORM_ANDROID_ANDROID_COMPOSITOR_VULKAN_H_
