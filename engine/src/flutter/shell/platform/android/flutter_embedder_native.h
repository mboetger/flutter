...
class FlutterEmbedderNative {
 public:
  ...
  bool RegisterHardwareBufferTexture(
      int64_t texture_id,
      std::shared_ptr<AndroidHardwareBuffer> initial_buffer = nullptr) const;
  ...
  bool RegisterVulkanTexture(int64_t texture_id,
                             std::shared_ptr<AndroidVulkanExternalTexture>
                                 initial_texture = nullptr) const;
