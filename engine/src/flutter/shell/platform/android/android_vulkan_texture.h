...
enum class AndroidVulkanFormat : uint32_t {
  ...
  kG8_B8_R8_3PLANE_420_UNORM = 1000156000,
  kG8_B8R8_2PLANE_420_UNORM = 1000156001,
};
...
struct AndroidVulkanImageDesc {
  uint32_t width = 0;
  uint32_t height = 0;
  uint32_t format = static_cast<uint32_t>(AndroidVulkanFormat::kR8G8B8A8_UNORM);
  ...
  static AndroidVulkanImageDesc MakeRGBA8(
    ...
    desc.width = width;
    desc.height = height;
    desc.format = static_cast<uint32_t>(AndroidVulkanFormat::kR8G8B8A8_UNORM);
