...
size_t AndroidHardwareBufferBytesPerPixel(uint32_t format) {
  ...
  switch (static_cast<AndroidHardwareBufferFormat>(format)) {
    case AndroidHardwareBufferFormat::kR8G8B8A8_UNORM:
    case AndroidHardwareBufferFormat::kR8G8B8X8_UNORM:
    case AndroidHardwareBufferFormat::kR10G10B10A2_UNORM:
    case AndroidHardwareBufferFormat::kD24_UNORM_S8_UINT:
    case AndroidHardwareBufferFormat::kD32_FLOAT:
    case AndroidHardwareBufferFormat::kR16G16_UINT:
    case AndroidHardwareBufferFormat::kR10G10B10A10_UNORM:
      return 4;
    case AndroidHardwareBufferFormat::kR8G8B8_UNORM:
      return 3;
    case AndroidHardwareBufferFormat::kR5G6B5_UNORM:
    case AndroidHardwareBufferFormat::kD16_UNORM:
    case AndroidHardwareBufferFormat::kD24_UNORM:
    case AndroidHardwareBufferFormat::kR16_UINT:
    case AndroidHardwareBufferFormat::kYCbCr_P010:
    case AndroidHardwareBufferFormat::kYCbCr_P210:
      return 2;
    case AndroidHardwareBufferFormat::kR16G16B16A16_FLOAT:
    case AndroidHardwareBufferFormat::kD32_FLOAT_S8_UINT:
      return 8;
    case AndroidHardwareBufferFormat::kR8_UNORM:
    case AndroidHardwareBufferFormat::kS8_UINT:
    case AndroidHardwareBufferFormat::kY8Cb8Cr8_420:
...
AndroidHardwareBufferDesc AndroidHardwareBufferDesc::MakeRGBA8(uint32_t width,
  ...
  desc.layers = 1;
  desc.format =
      static_cast<uint32_t>(AndroidHardwareBufferFormat::kR8G8B8A8_UNORM);
  desc.usage = usage;
  desc.stride = width;
  return desc;
}
...
void DefaultAndroidHardwareBufferProvider::EnsureLoaded() const {
  ...
  libandroid_ = library_loader_->LoadLibrary("libandroid.so");
  ...
  if (!from_hardware_buffer_fn_) {
    libjnigraphics_ = library_loader_->LoadLibrary("libjnigraphics.so");
